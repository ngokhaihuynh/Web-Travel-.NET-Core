...
namespace WebDuLich.Areas.Admin.Controllers
{
    ...
    public class AdminContactsController : Controller
    {
        ...
        public AdminContactsController(QLDLContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdLienHe,FullName,Email,Phone,CreatedAt,Note")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdLienHe,FullName,Email,Phone,CreatedAt,Note")] Contact contact)
        {
            if (id != contact.IdLienHe)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ContactExists(contact.IdLienHe))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Contacts.Any(e => e.IdLienHe == id);
        }
    }
}
