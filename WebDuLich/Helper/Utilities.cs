...
namespace WebDuLich.Helper
{
    ...
    public static class Utilities
    {
        ...
        public static async Task<List<string>> UploadFiles(List<Microsoft.AspNetCore.Http.IFormFile> files, string sDirectory, List<string> newnames = null)
        {
            List<string> uploadedFileNames = new List<string>();

            try
            {
                if (newnames == null || newnames.Count != files.Count)
                {
                    newnames = files.Select(file => file.FileName).ToList();
                }
            ...
            {
                // Tùy chọn ghi log ngoại lệ ở đây
                return null;
            }
